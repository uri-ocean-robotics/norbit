...
public:
    Message(){return;}
    bool fromBoostArray(boost::array<char, sizeof(norbit_msgs::msg::CommonHeader)> array){
        header_.reset(new norbit_msgs::msg::CommonHeader);
        memcpy(header_.get(),&array,sizeof(norbit_msgs::msg::CommonHeader));
        return headerValid();
    }
    norbit_msgs::msg::CommonHeader commonHeader(){return *header_;}
    bool headerValid(){
        return header_->preable==norbit_msgs::msg::CommonHeader::NORBIT_PREAMBLE_KEY &&
    ...
    bool msgValid(){
        std::uint32_t crc = CRC::Calculate(bits_.get(), header_->size - sizeof(norbit_msgs::msg::CommonHeader) , CRC::CRC_32());
...
protected:
    ...
    std::shared_ptr<norbit_msgs::msg::CommonHeader> header_;
