...
void bathymetric2SonarRanges(const norbit_msgs::msg::BathymetricStamped & in,
                              marine_acoustic_msgs::msg::SonarRanges & out) {
    auto num_beams = in.bathy.bathymetric_header.beam_number;
    ...
    for (size_t i = 0; i < num_beams; i++) {
        if (in.bathy.detections[i].quality_flag == 3) {
            out.flags[i].flag = marine_acoustic_msgs::msg::DetectionFlag::DETECT_OK;
        } else {
            out.flags[i].flag = marine_acoustic_msgs::msg::DetectionFlag::DETECT_BAD_SONAR;
        }
...
void bathymetric2SonarDetections(const norbit_msgs::msg::BathymetricStamped & in,
...
void norbitWC2RawSonarImage(const norbit_msgs::msg::WaterColumnStamped & in,
                              marine_acoustic_msgs::msg::RawSonarImage & out) {
    auto num_beams = in.water_column.water_column_header.beam_number;  // Number of beams
    auto num_samples = in.water_column.water_column_header.sample_number;  // Number of samples in each beam
    ...
    switch (in.water_column.water_column_header.dtype) {
        case norbit_msgs::msg::WaterColumnHeader::DTYPE_UINT8:
            out.image.dtype = marine_acoustic_msgs::msg::SonarImageData::DTYPE_UINT8;
            break;
        case norbit_msgs::msg::WaterColumnHeader::DTYPE_INT8:
            out.image.dtype = marine_acoustic_msgs::msg::SonarImageData::DTYPE_INT8;
            break;
        case norbit_msgs::msg::WaterColumnHeader::DTYPE_UINT16:
            out.image.dtype = marine_acoustic_msgs::msg::SonarImageData::DTYPE_UINT16;
            break;
        case norbit_msgs::msg::WaterColumnHeader::DTYPE_INT16:
            out.image.dtype = marine_acoustic_msgs::msg::SonarImageData::DTYPE_INT16;
            break;
        case norbit_msgs::msg::WaterColumnHeader::DTYPE_UINT32:
            out.image.dtype = marine_acoustic_msgs::msg::SonarImageData::DTYPE_UINT32;
            break;
        case norbit_msgs::msg::WaterColumnHeader::DTYPE_INT32:
            out.image.dtype = marine_acoustic_msgs::msg::SonarImageData::DTYPE_INT32;
            break;
        case norbit_msgs::msg::WaterColumnHeader::DTYPE_UINT64:
            out.image.dtype = marine_acoustic_msgs::msg::SonarImageData::DTYPE_UINT64;
            break;
        case norbit_msgs::msg::WaterColumnHeader::DTYPE_INT64:
            out.image.dtype = marine_acoustic_msgs::msg::SonarImageData::DTYPE_INT64;
            break;
        case norbit_msgs::msg::WaterColumnHeader::DTYPE_FLOAT32:
            out.image.dtype = marine_acoustic_msgs::msg::SonarImageData::DTYPE_FLOAT32;
            break;
        case norbit_msgs::msg::WaterColumnHeader::DTYPE_FLOAT64:
            out.image.dtype = marine_acoustic_msgs::msg::SonarImageData::DTYPE_FLOAT64;
            break;
    }
